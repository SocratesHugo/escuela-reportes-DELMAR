{{-- resources/views/filament/pages/snapshot-group-subject.blade.php --}}
<x-filament::page>
    <div class="mb-4">
        {{ $this->form }}
    </div>
    ...
    @if(!$group || !$week || !$gst)
        <x-filament::section>
            <div class="text-sm text-gray-500">Selecciona grupo, materia–grupo y semana.</div>
        </x-filament::section>
    @else
        <x-filament::section :heading="'Resumen — ' . $group->name . ' — ' . ($gst->subject?->name ?? 'Materia')">
